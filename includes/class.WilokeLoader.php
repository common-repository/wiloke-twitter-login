 ...
 * @since       1.0
 * @package     Wiloke_Submission
 * @subpackage  Wiloke_Submission/includes
 * @author      Wiloke Team
 */
...
if ( !class_exists('Wiloke_Loader') )
{
    class Wiloke_Loader
    {
         ...
         * @param property  $callback   The name of property will be callback
